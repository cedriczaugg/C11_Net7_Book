...
internal partial class Program
{
    private static void QueryingCategories()
    {
        using (Northwind db = new())
        {
            ...
            var eagerLoading = ReadKey(true).Key == ConsoleKey.Y;
            var explicitLoading = false;
            WriteLine();
            if (eagerLoading)
            {
            ...
            else
            {
                ...
                explicitLoading = ReadKey(true).Key == ConsoleKey.Y;
                WriteLine();
            }
    ...
    private static void FilteredIncludes()
    {
        using (Northwind db = new())
        {
            ...
            foreach (var c in categories)
            {
                ...
                foreach (var p in c.Products) WriteLine($"  {p.ProductName} has {p.Stock} units in stock.");
            }
        }
    }
    ...
    private static void GetRandomProduct()
    {
        using (Northwind db = new())
        {
            ...
            var rowCount = db.Products?.Count();
            if (rowCount == null)
            {
